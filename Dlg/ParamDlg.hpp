...
//-------------------------------------------------------------------------------------------------
/*
template<class Table, class Dlg>struct ParametersDlg: Dlg
{
	Table &table;	
...
*/
//---------------------------------------------------------------------------------------------------
//template<class Table, class Dlg>ParametersDlg<Table, Dlg>::ParametersDlg(Table &z): table(z), items(z.items){}
...
template<class T>struct Largen;
template<class T>struct LessEqual;
template<class T>struct LargenEqual;
